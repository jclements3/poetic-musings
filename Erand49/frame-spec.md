...
| Hidden tuners x49 (**ER-008**) | per string, ALTERNATING plates (24 left / 25 right, Paraguayan style): O6.5 access bore along the tuner-lead axis entering the plate TOP EDGE (Allen key inserts into the plate, nothing protrudes; nylon plug cap), 4.5x6x18 slider channel from the inner face, **O9 knurled steel bushing tapped M6x0.75 pressed+bonded**, M6 set screw (3 mm hex), 4x4x12 stainless slider with string hole | concert-pitch tuning without slip: axial-load fine thread cannot back-drive; 0.75 mm take-up/turn = cents-level control; max string ~300 N is <5% of the screw | CAD: 49 bores+channels cut in the plates (bushing edge margin 8.7 mm vs 4 needed); hardware ~0.4 kg total; BOM: 49x M6x0.75 set screws, 49x bushings, 49x sliders, 49x nylon plugs, 3 mm ball-end T-handle |
