...
| Crown collar (**ER-007**) | 60 mm length of the SAME 2.5 in x 3/16 midrib channel, ripped to 90 mm wall depth, slid over the pillar top, open side to the strings; web wraps the tube (tangent, ~5 mm proud of the plate front edge) | closes the 6.35 mm/side crown gap: outside faces 63.5 mm bear FLAT on both plates (the plate gap was derived from this channel); walls 54.0 mm apart around the O50.8 tube, 1.6 mm/side fillet welds | two M8 bolts through plate-wall-wall-plate at z_top-15/-45, 21 mm behind the tube (no crush loads, no contoured spacers); CAD: ER-007 in frame.step, crown-plan slice shows the closed joint |
