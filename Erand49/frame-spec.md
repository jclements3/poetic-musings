...
| Crown cap (**ER-007**) | vertical run of the SAME 2.5 in x 3/16 channel at the pillar, **walls cut back to wrap 5/8 of the pillar dia (36.5 mm total depth)**, top/bottom profile-cut to the neck rails; web faces forward, **seated flush on a 2 mm-deep milled/filed flat on the tube front** (~20 mm wide chord, over the cap height only — real face bearing, JC's filing suggestion adopted) | closes the crown gap and blocks the front (YZ) view of optics/strings: outside faces 63.5 mm flat on both plates, walls 54 mm clear around the tube (1.6 mm/side fillet welds + two vertical welds along the web tangent) | two **M8 through-pillar bolts with crush sleeves** (same detail as the base pillar bolts) at 15/45 mm below the plate corner: plate-wall-tube-wall-plate; ER-007 sheet (two views) + crown-plan slice in LAYOUT.html |
