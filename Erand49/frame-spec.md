...
| Crown cap (**ER-007**) | vertical run of the SAME 2.5 in x 3/16 channel at the pillar, **walls cut back to wrap 5/8 of the pillar dia (36.5 mm total depth)**, top/bottom profile-cut to the neck rails; web faces forward, **inner face tangent on the tube** (line contact + two vertical fillet welds — no filing), and the **neck plates extend forward at the crown to sit flush with the cap's front face** | closes the crown gap and blocks the front (YZ) view of optics/strings: outside faces 63.5 mm flat on both plates, walls 54 mm clear around the tube (1.6 mm/side fillet welds + two vertical welds along the web tangent) | two **M8 through-pillar bolts with crush sleeves** (same detail as the base pillar bolts) at 15/45 mm below the plate corner: plate-wall-tube-wall-plate; ER-007 sheet (two views) + crown-plan slice in LAYOUT.html |
| Axle-tube tuners x49 (**ER-008**) | per string, an O12x2 6061 tube pressed through BOTH plates at the FLAT PIN point (supersedes tuner posts/leads): inside, an M6x0.75 lead screw the tube's length with a slider-nut; string enters a 3 mm center slot over a hardened radiused edge (90-deg bend) — the slot edge at y=0 IS the speaking-length reference; steel nut insert in the right end, press cap left | the 49 tubes make the plate pair a LADDER TRUSS and self-jig the 63.5 gap (0.03 mm rung deflection at 300 N); all 49 hex sockets recessed in the RIGHT tube ends — one-side tuning like a regular harp, wrench inserts into the frame | self-locking: post-bend string tension loads the screw axially (fine thread cannot back-drive); 0.75 mm/turn = cents; ~20% capstan set across the bend (settle with a tap, as pianos do); CAD: 49 through-bores both plates, tube edge margin 6.5 mm; BOM: 49x tube, lead screw, slider-nut, nut insert, press cap; 3 mm ball-end T-handle |
