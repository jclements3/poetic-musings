...
% ---------------------------------------------------------------------
\newcommand{\acr}[3]{\pdftooltip{\hyperlink{gls:#1}{#2}}{#3}}
...
reading. In Adobe Acrobat or Adobe Reader specifically, hovering over one of these linked
acronyms also opens a small popup with the full definition inline, without leaving the
page -- other PDF viewers (browsers, Preview, most mobile readers) do not render that
hover popup, and will simply behave as a normal link instead.
\end{note}
